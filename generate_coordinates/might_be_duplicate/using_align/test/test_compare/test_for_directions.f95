...
real(kind=8), allocatable, dimension(:,:) :: matrix, matrixa, matrixb
real(kind=8), allocatable, dimension(:) :: masa
integer :: i, j, n, prod11

n = 20
allocate( matrix(n,3), masa(n) ) 
allocate( matrixa(n,4), matrixb(n,4) )
...
call compare(matrixa,matrixb,n,prod11)
